...
export default function Services() {
  return (
    <section className="py-10 px-4 bg-gradient-to-br from-white to-gray-100 relative overflow-hidden">
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="relative h-80 md:h-96 overflow-hidden">
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent group-hover:from-black/70 transition-all duration-500`}
                />

                {/* Overlay de color temático */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-20 group-hover:opacity-10 transition-opacity duration-500`}
                />
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="transform transition-transform duration-500 group-hover:translate-y-[-8px]">
                  <div className="flex items-end justify-between">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm hover:bg-cyan-400 hover:text-white text-white p-4 rounded-full transition-all duration-300 flex-shrink-0 ml-6 group-hover:scale-110 border border-white/20 hover:border-cyan-400">
                      <svg
